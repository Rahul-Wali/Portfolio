...
import { useScrollProgress, useReducedMotion, useDevicePerformance } from "@/hooks";
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 overflow-x-hidden" onMouseMove={handleMouseMove}>
      <AIBackground
      ...
      <main className="flex-1 relative z-10" id="main-content">
        <Hero scrollProgress={scrollProgress} mousePosition={mousePosition} />
        <About />
        <EngineeringPipeline />
        <Experience />
        <Projects />
